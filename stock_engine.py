...
NIFTY_50 = [
    ...
    "HINDUNILVR", "SBIN", "AXISBANK", "ITC", "LT", "BHARTIARTL",
    "BAJFINANCE", "ASIANPAINT", "HCLTECH", "MARUTI", "WIPRO", "SUNPHARMA",
    "HDFC", "ULTRACEMCO", "TECHM", "NTPC", "ONGC", "POWERGRID", "TITAN",
    "TATASTEEL", "COALINDIA", "ADANIENT", "GRASIM", "DIVISLAB"
]
